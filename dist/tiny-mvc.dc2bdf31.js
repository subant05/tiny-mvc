...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"src/router.Utils.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.templateTranspiler = templateTranspiler;
exports.decorateDefineController = decorateDefineController;
...
var _ieGetScopedProperty = function R(currentScope, path, value) {
...
function _bindOnmountedEvents() {
  ...
  if (this.onmountedHandlers.length) {
    this.onmountedHandlers.forEach(function (func) {
      _this.onmounted(func);
    });
...
function _bindUnnmountedEvents() {
  ...
  if (this.onunmountedHandlers.length) {
    this.onunmountedHandlers.forEach(function (func) {
      _this2.onunmounted(func);
    });
...
function decorateDefineController(controller, template, that) {
  ...
  var Renderer = /*#__PURE__*/function (_controller) {
    _inherits(Renderer, _controller);

    var _super = _createSuper(Renderer);

    function Renderer(data, state) {
      var _this3;

      _classCallCheck(this, Renderer);

      _this3 = _super.call(this, data, state);

      _bindOnmountedEvents.call(_assertThisInitialized(_this3));

      _bindUnnmountedEvents.call(_assertThisInitialized(_this3));
    ...
    _createClass(Renderer, [{
      ...
      value: function mounted() {
        var event = createEvent(eventTypes.mounted);
        pipeline.dispatchEvent(event);
        this.mounted = null;
      }
    }, {
      key: "onmounted",
      value: function onmounted(func) {
        pipeline.addEventListener(eventTypes.mounted, function (e) {
          return func(e);
        }, false);
      }
    }, {
      ...
      value: function unmounted() {
        var event = createEvent(eventTypes.unmounted);
        pipeline.dispatchEvent(event);
        this.unmounted = null;
      }
    }, {
      key: "onunmounted",
      value: function onunmounted(func) {
        pipeline.addEventListener(eventTypes.unmounted, function (e) {
          return func(e);
        }, false);
      }
    }, {
      ...
      value: function toggleSubmitButton() {
        ...
        var disabled = this.submitButton.disabled;
      ...
      key: "routerRedirect",
      value: function routerRedirect(newPath) {
...
},{}],"src/router.Controller.js":[function(require,module,exports) {
"use strict";
...
var RouterController = /*#__PURE__*/function () {
  function RouterController(data, state) {
  ...
  _createClass(RouterController, [{
    key: "onunmounted",
    value: function onunmounted(handler) {
...
var _router = require("./router.Utils");

var _router2 = _interopRequireDefault(require("./router.Controller"));
...
var Router = /*#__PURE__*/function () {
  function Router(routes, state, root) {
  ...
  _createClass(Router, [{
    ...
    value: function addClickHandler() {
      ...
      document.addEventListener("click", function (event) {
        return _this.pushStateHandler(event, _this.state, _this.routes);
      });
    }
  }, {
    key: "addPopstateHandler",
    value: function addPopstateHandler() {
      var _this2 = this;

      window.addEventListener("popstate", function (event) {
        return _this2.historyHandler(event, _this2.state, _this2.routes);
      });
    }
  }, {
    key: "insertPageLoader",
    value: function insertPageLoader() {
    ...
    key: "parseTemplate",
    value: function parseTemplate(scope, template) {
      return (0, _router.templateTranspiler)(template, scope);
    }
  }, {
    key: "getTemplate",
    value: function () {
      var _getTemplate = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(path) {
        var _this3 = this;
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _context.abrupt("return", new Promise(function (resolve, reject) {
                  ...
                  xhr.open("get", _this3.routes[path].template, true);
    ...
    key: "loadService",
    value: function () {
      var _loadService = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(path) {
        var serviceData;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 4;
                return this.routes[path].service(this.state[path]);

              case 4:
                serviceData = _context2.sent;

              case 5:
                return _context2.abrupt("return", serviceData);
    ...
    key: "executeController",
    value: function executeController(path, serviceData, template) {
      var Renderer = (0, _router.decorateDefineController)(this.routes[path].controller, template, this);
      return new Renderer(Object.assign(Object.create(this.state[path]), serviceData), this.state).mounted();
    }
  }, {
    key: "add404Route",
    value: function add404Route() {
      if (!this.routes["".concat(this.root, "/404")]) {
        this.routes["".concat(this.root, "/404")] = {
          controller: /*#__PURE__*/function (_RouterController) {
            _inherits(PageNotFound, _RouterController);
        ...
        this.state["".concat(this.root, "/404")] = {};
      }
    }
  }, {
    key: "render404",
    value: function render404() {
      this.add404Route();
      this.executeController("".concat(this.root, "/404"), {}, "<div>404 - Page Not Found</div>");
    }
  }, {
    key: "is404Error",
    value: function is404Error(path) {
    ...
    key: "routerRender",
    value: function () {
      var _routerRender = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(path) {
        var loader, serviceData, template;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                loader = this.insertPageLoader();
                _context3.next = 5;
                return this.loadService(path);

              case 5:
                serviceData = _context3.sent;
                _context3.next = 8;
      ...
      function routerRender(_x3) {
        return _routerRender.apply(this, arguments);
      }
    ...
    key: "historyHandler",
    value: function () {
      var _historyHandler = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(event) {
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                if (!(_typeof(event.state) !== "object" || !(event.state.path in this.routes))) {
                  _context4.next = 2;
                  break;
                }
              ...
              case 2:
                if (_typeof(this.state[event.state.path]) !== "object" && this.saveState) {
      ...
      function historyHandler(_x4) {
        return _historyHandler.apply(this, arguments);
      }

      return historyHandler;
    }()
  }, {
    key: "pushStateHandler",
    value: function pushStateHandler(event) {
      if (event.target.tagName.toLowerCase() === "a") {
        ...
        }, event.target.title, event.target.pathname);
    ...
    key: "pageLoadHander",
    value: function pageLoadHander(path) {
      if (location.pathname && location.pathname !== "/" && location.pathname !== this.root) {
        var savedState = JSON.parse(localStorage.getItem("routerState"));
...
global.tinyMVC = {
  ...
  RouterController: _router.RouterController
};
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","./src/router":"src/router.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","tiny-mvc.js"], null)
//# sourceMappingURL=/tiny-mvc.dc2bdf31.js.map