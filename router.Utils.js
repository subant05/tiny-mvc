...
function _ieParseTemplate(template,scope ){
...
function _decorateDefineController(controller, template, that){
    ...
    class Renderer extends controller {
        ...
        toggleSubmitButton(){
            ...
            disabled ? LoaderCircular.hide (this.submitButton) : LoaderCircular.show (this.submitButton)
        }
...
export {_ieParseTemplate, _decorateDefineController}
